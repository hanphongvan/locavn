-- Companion: EF migration 20260430120000_AddStoreAdminInventoryTransactionHeadersDeleteProcedure.
-- Deletes inventory voucher header; StationInventoryTransactionDetails cascade.
