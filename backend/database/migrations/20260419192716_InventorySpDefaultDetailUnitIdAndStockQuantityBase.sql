-- Companion script for EF migration `20260419192716_InventorySpDefaultDetailUnitIdAndStockQuantityBase`.
-- Adds `@DefaultDetailUnitId` on save/update inventory SPs; inventory-current uses `QuantityForStock` (demo = line qty).
-- Generated via `dotnet ef migrations script` (includes `__EFMigrationsHistory` row).
