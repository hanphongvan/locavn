-- Companion script for EF Core migration `20260419191922_InventoryTransactionDetailsRequireUnitIdXmlAndUnitName`.
-- Applies helper SPs, strict `unitId` on inventory save/update XML, and `UnitName` on detail reads.
