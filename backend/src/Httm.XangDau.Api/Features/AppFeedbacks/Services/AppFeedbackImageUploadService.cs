...
public sealed class AppFeedbackImageUploadService(
    IWebHostEnvironment env,
    IConfiguration configuration) : IAppFeedbackImageUploadService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var dir = Path.Combine(webRoot, "uploads", "app-feedback");
        ...
        var relativeUrl = $"/uploads/app-feedback/{name}";
    ...
    {
        var configured = configuration["AppFeedback:UploadedImagePublicBaseUrl"]?.Trim();
