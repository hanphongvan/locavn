...
{
    /// <inheritdoc />
    public partial class AddStoreAdminInventoryCurrentStoredProcedures : Migration
    {
        /// <inheritdoc />
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS dbo.sp_StoreAdmin_InventoryCurrent_ListByStore;");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS dbo.sp_StoreAdmin_InventoryCurrent_ListPaged;");
        }
    }
}
