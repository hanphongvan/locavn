...
{
    /// <inheritdoc />
    public partial class FixStoreAdminInventoryCurrentListPagedAggCteScope : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // CTE Agg is only in scope for the single statement after WITH; fill #Agg (CREATE + INSERT)
            // then COUNT and OFFSET/FETCH (fixes "Invalid object name 'Agg'").
