...
/// <summary>SQL for <see cref="InventoryTransactionDetailsRequireUnitIdXmlAndUnitName"/> — strict <c>unitId</c> in XML + detail list exposes <c>UnitName</c>.</summary>
internal static class InventoryTransactionDetailsRequireUnitIdXmlAndUnitNameProcedures
{
    internal const string DonViTinhExists =
        """
    ...
    internal const string FuelProductUnitById =
        """
    ...
    internal const string ListByHeaderId =
        """
