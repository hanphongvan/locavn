...
/// <summary>SQL batches for <see cref="StationInventoryTransactionDetailsUnitId"/> (keeps migration file readable).</summary>
internal static class StationInventoryTransactionDetailsUnitIdProcedures
{
    internal const string BackfillAndAlterNotNull =
        """
        DECLARE @Liter INT = (
            SELECT TOP (1) [Id]
