...
namespace Httm.XangDau.Api.Shared.Persistence.Migrations
{
    ...
    public partial class AddStationOperatingHours : Migration
    {
        ...
        {
            // Legacy DMPPortal DBs already have dbo.DM_DonVi. Greenfield / empty DBs do not — FK below would fail.
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpensAt = table.Column<TimeOnly>(type: "time(0)", nullable: true),
                    ClosesAt = table.Column<TimeOnly>(type: "time(0)", nullable: true),
                    IsClosedAllDay = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StationOperatingHours", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StationOperatingHours_DM_DonVi_DonViId",
                        column: x => x.DonViId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StationOperatingHours_DonViId_DayOfWeek",
                table: "StationOperatingHours",
                columns: new[] { "DonViId", "DayOfWeek" },
                unique: true);
        }
