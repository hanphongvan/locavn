...
/// <summary>Table <c>QT_TK_ThongKeChiTiet_ChuyenDuLieu</c> (keyless per schema) — <c>docs/architecture/database.md</c>.</summary>
public sealed class QtTkThongKeChiTietChuyenDuLieu
{
