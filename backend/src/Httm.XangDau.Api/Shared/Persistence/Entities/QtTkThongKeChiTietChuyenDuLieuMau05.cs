...
/// <summary>Table <c>QT_TK_ThongKeChiTiet_ChuyenDuLieu_Mau05</c> (keyless) — <c>docs/architecture/database.md</c>.</summary>
public sealed class QtTkThongKeChiTietChuyenDuLieuMau05
{
