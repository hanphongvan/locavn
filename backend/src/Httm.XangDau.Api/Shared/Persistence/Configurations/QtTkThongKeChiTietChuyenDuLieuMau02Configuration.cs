...
public sealed class QtTkThongKeChiTietChuyenDuLieuMau02Configuration : IEntityTypeConfiguration<QtTkThongKeChiTietChuyenDuLieuMau02>
{
    public void Configure(EntityTypeBuilder<QtTkThongKeChiTietChuyenDuLieuMau02> b)
    {
        b.ToTable("QT_TK_ThongKeChiTiet_ChuyenDuLieu_Mau02");
        b.HasNoKey();
