...
/// Design tokens — tab Nhiên liệu (đồng bộ spec #10 + LocaVN).
abstract final class FuelPalette {
  ...
  static const Color redChange = Color(0xFFF04438);
  static const Color greenChange = Color(0xFF16A34A);
